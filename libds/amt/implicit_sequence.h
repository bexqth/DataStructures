...
namespace ds::amt {
    ...
    {
        return *this->getMemoryManager()->allocateMemory(); // deferencovat aby nam vratil objekt blockType a nie referenciu
    }
	...
	{
        // vopred si rezervujeme kapacitu
